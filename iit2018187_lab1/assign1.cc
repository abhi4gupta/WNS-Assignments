...
//p2p UDP flow between n1(10.1.1.1) -------> n2(10.1.2.2)
...
NS_LOG_COMPONENT_DEFINE ("Lab1 Assignment");
...
//
// creating the channels required by the topology explicitly.
//
  ...
  for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end (); ++i)
    {
      ...
      {
          std::cout << "in Flow " << i->first  << " (" << t.sourceAddress << " -> " << t.destinationAddress << ")\n";
          std::cout << "  Transfered Bytes:   " << i->second.txBytes << "\n";
          std::cout << "  Recieved Bytes:   " << i->second.rxBytes << "\n";
      	  std::cout << "  Throughput of connection : " << i->second.rxBytes * 8.0 / (i->second.timeLastRxPacket.GetSeconds() - i->second.timeFirstTxPacket.GetSeconds())/1024/1024  << " Mbps\n";
      }
     }
